...
class ServerPage extends Page {
    ...
    override function initialize() {
        ...
        _image = GenesisApplicationTheme.getCommonIcon( SuperHumanInstallerTheme.IMAGE_LOGO );
        ...
        _serverList.addEventListener( SuperHumanApplicationEvent.OPEN_FTP_CLIENT, _forwardEvent );
        ...
        _serverList.addEventListener( SuperHumanApplicationEvent.SUBMIT_DEBUG_REPORT, _forwardEvent );
        _serverList.addEventListener( SuperHumanApplicationEvent.CLONE_SERVER, _forwardEvent );
        #if debug
