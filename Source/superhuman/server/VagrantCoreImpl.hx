...
import superhuman.server.VagrantCoreDefinition.VagrantCoreType;
import sys.FileSystem;
import sys.io.File;

class VagrantCoreImpl implements IVagrantCore {
    ...
    function get_data():VagrantCoreData return { type: _type, version: _version };
    ...
    function new( type:VagrantCoreType, sourcePath:String, targetPath:String ) {
